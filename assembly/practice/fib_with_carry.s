...
FIBBY:
     ...
     lea rsi, FIB_MESSAGE[rip]
     mov rdx, OFFSET FIB_MESSAGE_LEN
     syscall
...
.section .rodata
     ...
     CARRY_OUTPUT: .asciz "%3lu: %lx %016lx %016lx\n" 
     .set CARRY_OUTPUT_LEN, . - CARRY_OUTPUT

     OUTPUT: .asciz "%3lu: %lx %016lx\n" 
     .set OUTPUT_LEN, . - OUTPUT

     OUTPUT_NO_CARRY: .asciz "%3lu: %lx\n" 
     .set OUTPUT_LEN, . - OUTPUT_NO_CARRY

     FIB_MESSAGE: .ascii "Enter number: "
     .set FIB_MESSAGE_LEN, . - FIB_MESSAGE
